...
def patch_status_edit_delete_icons(tg: Path) -> None:
    ...
    new_date = (
        ...
        "                // Icon target height = digit cap height + a tiny optical nudge (+0.5pt).\n"
        "                // A thin outline glyph reads slightly smaller than the solid digits at\n"
        "                // equal height, so a half-point bump makes it look balanced, not bigger.\n"
        "                let aorusCapH = dateFont.capHeight.rounded() + 0.5\n"
